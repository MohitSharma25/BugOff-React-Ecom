  ...
  return (
    <header>
        ...
        <div className="flex items-center bg-black p-1 flex-grow py-2">
            ...
            {/* Search */} 
            <div className="hidden srchbox sm:flex items-center h-10 w-3 rounded-md flex-grow cursor-pointer bg-pink-400 hover:bg-green-500">
                <input className="p- h-full width-2  flex-shrink rounded-l-md focus:outline-none px-80 " type="text" />
            ...
            <div className="text-white flex items-center text-xs space-x-6 mx-6 whitespace-nowrap">
                ...
                <div className="relative link flex items-center">
                    ...
                    <p className="cart hidden md:inline  md:text-sm mt-2">Cart</p>
                </div>
